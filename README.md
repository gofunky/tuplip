...
- [Sources](#sources)
  ...
  * [From Dockerfile](#from-dockerfile)
    ...
    + [Versioned FROM Instructions](#versioned-from-instructions)
    + [Unversioned FROM Instructions](#unversioned-from-instructions)
    + [Multiple Vectors per Instruction](#multiple-vectors-per-instruction)
- [Flags](#flags)
  ...
  * [root-version](#root-version)
    + [Example](#example-9)
    + [Pushed Tags](#pushed-tags-1)
  * [straight](#straight)
    + [Example](#example-10)
    + [Pushed Tags](#pushed-tags-2)
  * [filter](#filter)
    + [Example](#example-11)
    + [Result](#result-9)
  * [verbose](#verbose)
